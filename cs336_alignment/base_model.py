...
from drgrpo_grader import smart_reward_fn
...
def main():
    ...
    # exit(0)
    verify_model = init_vllm(args.model_id, device="cuda:0", seed=args.seed, gpu_memory_utilization=0.85)
    ...
    best_acc = 0
    # load_policy_into_vllm_instance(train_model, verify_model)
    acc = evaluate(args,_logger,verify_model, sample_num=1024, reward_fn=smart_reward_fn, dataset_type="json")
